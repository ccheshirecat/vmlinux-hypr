...
struct kvm_x86_ops {
	...
	/* HYPR EPT swap operations */
	int (*get_eptp)(struct kvm_vcpu *vcpu, u64 *eptp);
	int (*set_eptp)(struct kvm_vcpu *vcpu, u64 new_eptp);
	int (*prepare_ept_swap)(struct kvm *kvm, struct kvm_ept_prepare *prepare);
#endif
};
